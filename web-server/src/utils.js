...
const forecast = (latitude, longitude, callback) => {
    ...
    request({
        ...
        if (error) {
            ...
            callback(undefined, data.daily.data[0].summary + ' It is currently ' + data.currently.temperature + ' degress out. There is a ' + data.currently.precipProbability + '% chance of rain.')
        }
